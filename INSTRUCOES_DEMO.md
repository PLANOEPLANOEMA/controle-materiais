...
const auth = {
  ...
  aplicarPermissoes(sessao) {
    ...
    const permitidas = {
      admin: ['visao-geral','por-empresa','por-material','registros','materiais-obra','rastreabilidade','relatorio','relatorio-dia'],
      almoxarife: ['materiais-obra','rastreabilidade','relatorio','relatorio-dia'],
      go: ['materiais-obra','rastreabilidade','relatorio','relatorio-dia'],
  ...
  pode(acao) {
    ...
    const mapa = {
      admin: ['editar_emprestimos','editar_materiais','deletar_materiais','registrar_retirada','ver_rastreabilidade','ver_relatorio_dia','excluir_rastreabilidade','ver_relatorio_completo'],
      almoxarife: ['editar_materiais','deletar_materiais','registrar_retirada','ver_rastreabilidade','ver_relatorio_dia','ver_relatorio_completo'],
      go: ['ver_rastreabilidade','ver_relatorio_dia','ver_relatorio_completo'],
